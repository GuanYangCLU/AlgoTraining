...
/**
 *  The {@code WeightedQuickUnionUF} class represents a <em>union鈥揻ind data type</em>
 ...
 *  sites, named 0 through <em>n</em>鈥�1.
...
public class WeightedQuickUnionUF {
    ...
    /**
     * Initializes an empty union鈥揻ind data structure with {@code n} sites
