...
public class BreadthFirstPaths {
    ...
    public static void main(String[] args) {
        In in = new In("Wiener.txt");  //input Graph from here
        Graph G = new Graph(in);
        // StdOut.println(G);

        int s_sum = 14;
        int wiener_sum = 0;
        for (int s=0; s<s_sum;s++){    //print path for each vertex
        ...
        StdOut.println("The Wiener Index (shortest sum of path distances) is: " + wiener_sum/2);
    }
